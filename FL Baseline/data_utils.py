...
def load_data_for_client(cid: int, batch_size: int = 32):  # Changed name
    """
    Split MNIST into 10 disjoint partitions for baseline clients 0-9.
    Each client gets 3000 samples.
    """
